...
# Regex to extract "Mxxxxx/Type/xxxxxx"
...
# Choose embedding method ("ASE" or "LSE")
...
for (file in filenames) {
  ...
  pdf_filename <- paste0(pdf_filename_base, "_", EMBEDDING_METHOD, '.pdf')
